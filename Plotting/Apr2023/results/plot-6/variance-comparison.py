...
# Plot variances
def plot_variances(all_variances, errbars=None, avgN=0, fig_title=None):
    plt.figure("Variances")
    ax = plt.gca()
    #ax.set_title(fig_title)
    for i, variance in enumerate(all_variances):
        plot_subplot_data(variance, name_list[i], color_list[i], jfirst_list[i], ax=ax, avgN=avgN, errbars=errbars[i], subplot_title=fig_title)
    ax.legend(loc='upper right', bbox_to_anchor=(.95, 1.0))
...
def main():
    ...
    h2ogs_files = [gvp_h2ogs_filenames, 
                   te_h2ogs_filenames,
                   edesc_h2ogs_filenames, 
                   lm_h2ogs_filenames]
    target_state_used_list = [False, True, False, False]
    ...
    plot_variances(shrunk_h2ogs_variance, errbars=shrunk_h2ogs_variance_err, fig_title='H2O Ground State')
    plt.show()
    ...
    plot_variances(shrunk_h2o1b1_variance, errbars=shrunk_h2o1b1_variance_err, fig_title='H2O 1B1 State')
    plt.show()
    ...
    plot_variances(shrunk_formgs_variance, errbars=shrunk_formgs_variance_err, fig_title='Formaldehyde Ground State')
    plt.show()
    ...
    # plot_energies(shrunk_formn2p_energies, errbars=shrunk_formn2p_err, fig_title='Formaldehyde N to Pi* State')
    # plot_target_functions(shrunk_formn2p_targetfn, errbars=shrunk_formn2p_target_err, fig_title='Formaldehyde N to Pi* State')
    plot_variances(shrunk_formn2p_variance, errbars=shrunk_formn2p_variance_err, fig_title='Formaldehyde N to Pi* State')
    plt.show()
    ...
    plot_energies(shrunk_formp2p_energies, errbars=shrunk_formp2p_err, fig_title='Formaldehyde Pi to Pi* State')
    # plot_target_functions(shrunk_formp2p_targetfn, errbars=shrunk_formp2p_target_err, fig_title='Formaldehyde Pi to Pi* State')
    plot_variances(shrunk_formp2p_variance, errbars=shrunk_formp2p_variance_err, fig_title='Formaldehyde Pi to Pi* State')
    plt.show()
